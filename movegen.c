...
#define GETMVVLVASCORE()(MvvLvaScores[pos->pieces[get_move_target(move)]][pos->pieces[get_move_source(move)]] + 1000000;)
...
static inline void add_move(S_MOVELIST *list, int move, S_BOARD *pos)
{
    // store move
...
static inline void add_promotion_moves(S_MOVELIST *move_list, int source_square, int target_square, int piece, int capture, S_BOARD *pos)
{
